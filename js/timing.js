try { if (document.getElementsByClassName('timing')[0].clientWidth) timing(); } catch (error) {}

function timing(){
    let exTime = document.getElementsByClassName("timing")[0];
